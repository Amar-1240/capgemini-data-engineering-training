...
/*insert data into regex practice table*/
...
the value.The extraction must stop as soon as a non-numeric character appears.*/
SELECT id, mixed_value, 
REGEXP_SUBSTR(mixed_value, '^[0-9]+') AS extracted_numbers 
FROM regex_practice;
